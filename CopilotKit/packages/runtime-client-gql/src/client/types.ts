...
// FileMessageInput interface for FileMessage (will be generated by GraphQL codegen in task 4)
export interface FileMessageInputFields {
  mimeType: string;
  bytes: string;
  fileName: string;
  role: MessageRole;
...
type FileMessageConstructorOptions = MessageConstructorOptions & FileMessageInputFields;

export class FileMessage extends Message implements FileMessageInputFields {
  mimeType: string;
  bytes: string;
  fileName: string;
  role: MessageRole;
  ...
  constructor(props: FileMessageConstructorOptions) {
    super(props);
